...
- Tech Stack: TypeScript, Node.js, Zod
- Design Philosophy: Follow existing codebase patterns, maintain test coverage above 80%, keep changes minimal and focused
